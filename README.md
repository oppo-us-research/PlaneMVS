...
We provide several [model checkpoints](https://1drv.ms/f/c/339fd99c959aa6e5/EpSepVUHB1hHoilq0EfsIRoBvS5whEHtuQ6yOJnTAX2maA?e=nRF7U4) trained on ScannNetv2, by varying the training data size, training epoch and batch size, and so on. 
