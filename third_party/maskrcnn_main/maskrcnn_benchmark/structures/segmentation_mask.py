...
class BinaryMaskList(object):
    ...
    def __init__(self, masks, size):
        ...
        # ------------------------------
        #self.device = device
        #print_indebugmode (f">>>> ???? BinaryMaskList(): masks = {type(masks)}, device={self.device}")
    ...
    def crop(self, box):
        ...
        #return BinaryMaskList(cropped_masks, cropped_size, self.device)
    ...
    def to(self, *args, **kwargs):
        ...
        # Updated by PlaneMVS's authors;
        # ------------------------------
        #assert isinstance(self.masks, torch.Tensor), "Requre torch.Tensor"
    ...
    def __getitem__(self, index):
        ...
        #print (f'??? BinaryMaskList index = {index}, self.masks = {self.masks.device}')
...
class SegmentationMask(object):
    ...
    def to(self, device, *args, **kwargs):
        # added for BinaryMaskList case;
        if isinstance(self.instances, BinaryMaskList):
